...
function CountriesPageContent({ countryStats }: { countryStats: CountryStats[] }) {
  ...
  return <div className="space-y-6">
    ...
    <Card className="border-slate-200"><CardHeader className="border-b border-slate-100 px-6 py-5"><CardTitle className="flex items-center gap-2 text-lg"><Globe2 className="h-5 w-5 text-[#8b7435]" />Bookings by country</CardTitle></CardHeader><CardContent className="grid gap-4 p-6 sm:grid-cols-2 lg:grid-cols-4">
