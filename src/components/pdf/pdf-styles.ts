...
export const S = StyleSheet.create({
  ...
  pricingRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 8, paddingHorizontal: 10, borderBottomWidth: 0.8, borderBottomColor: "rgba(184,150,58,0.45)" },
  ...
  pricingOfferNotes: { marginBottom: 6 },
