...
export function itineraryRowToBooking(it: any): BookingConfig {
  ...
  return {
    ...
    customDayRoutes: bd.customDayRoutes || undefined,
    ...
    customPrivacy: bd.customPrivacy || undefined,
    offerTitle: bd.offerTitle || undefined,
    offerNote: bd.offerNote || undefined,
