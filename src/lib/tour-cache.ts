...
function tourToRow(t: Tour, scrapedAt: string) {
  return {
    ...
    duration_label: t.durationLabel ?? null,
    location: t.location ?? null,
    group_name: t.group ?? null,
    language: t.language ?? null,
    overview: t.overview ?? null,
    overview_html: t.overviewHtml ?? null,
    meeting_point: t.meetingPoint ?? null,
    meeting_point_html: t.meetingPointHtml ?? null,
    meeting_point_images: t.meetingPointImages ?? null,
    trip_notes: t.tripNotes ?? null,
    gallery_images: t.galleryImages ?? null,
